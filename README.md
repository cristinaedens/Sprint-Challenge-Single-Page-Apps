...
> Answer: • Client side routing makes it so we can reload a page without doing a server request. It doesn't refresh and the data is still displayed. This means the page loads faster.
